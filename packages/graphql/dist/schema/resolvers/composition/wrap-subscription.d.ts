...
export declare const wrapSubscription: (
    resolverArgs: WrapSubscriptionArgs
) => (
    next: GraphQLFieldResolver<any, Neo4jGraphQLComposedSubscriptionsContext>
) => (root: any, args: any, context: Neo4jGraphQLSubscriptionsContext, info: GraphQLResolveInfo) => Promise<unknown>;
//# sourceMappingURL=wrap-subscription.d.ts.map
