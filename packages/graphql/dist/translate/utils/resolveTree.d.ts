...
export declare function getResolveTreeByFieldName({
    fieldName,
    selection,
}: {
    fieldName: string;
...
export declare function getAliasedResolveTreeByFieldName({
    fieldName,
    selection,
}: {
    fieldName: string;
...
export declare function filterFieldsInSelection<T extends BaseField>({
    fields,
    selection,
}: {
    fields: T[];
...
export declare function generateResolveTree({
    name,
    alias,
    args,
    fieldsByTypeName,
...
export declare function generateMissingOrAliasedFields({
    fieldNames,
    selection,
}: {
    selection: Record<string, ResolveTree>;
